...
(def model-aliases
  {"haiku"    "claude-haiku-4-5-20251001"
   ...
   "fable"    "anthropic-tc:claude-fable-5-1"
   "fable51"  "anthropic-tc:claude-fable-5-1"
   ...
   "o3"       "o3"
   "o4-mini"  "o4-mini"
   "gpt"      "openai-tc:gpt-6-astra"
   "astra"    "openai-tc:gpt-6-astra"
   "gpt6"     "openai-tc:gpt-6-astra"
   "gpt6astra" "openai-tc:gpt-6-astra"
   "gpt52"    "gpt-5.2"
   "gpt53"    "gpt-5.3"
