...
Check `AGENTS.md` and `docs/CHANGELOG.md` for the checked-out release state; do not assume an older release is still unreleased. Public API and configuration details live in `docs/api.md`.
