...
Clone the repo and ask your agent to perform setup; it should discover the repo-local `spell-setup` skill. The prerequisites are Java, Clojure, and local Codex authentication for the default GPT-6 Astra model. Other providers can be selected explicitly.
